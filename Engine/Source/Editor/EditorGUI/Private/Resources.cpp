	...
	namespace EditorGUI
	{
		namespace Private
		{
			...
			Resources::Resources(void)
			{
				...
				Construct(m_ResourceHolder, Path::Combine(FileSystem::GetWorkingPath(), WString(LIBRARY_DIRECTORY_PATH)), Path::Combine(FileSystem::GetWorkingPath(), WString(ASSETS_DIRECTORY_PATH)), false);
