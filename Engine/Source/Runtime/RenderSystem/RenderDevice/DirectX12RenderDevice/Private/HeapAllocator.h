	...
	namespace DirectX12RenderDevice
	{
		namespace Private
		{
			...
			public:
				...
				{
					CoreDebugAssert(Categories::RenderSystem, m_Heap != nullptr, "Allocator already deinitialized");
					...
					RenderSystemAllocators::RenderSystemAllocator_Deallocate(m_BlockStates);
			...
			protected:
				...
				{
					CoreDebugAssert(Categories::RenderSystem, m_Heap == nullptr, "Allocator already initialized");

					m_Device = Device;
					m_BlockSize = BlockSize;
					m_BlockCount = BlockCount;

					m_BlockStates = RenderSystemAllocators::RenderSystemAllocator_AllocateArray<bool>(m_BlockCount);
					PlatformMemory::Set(m_BlockStates, 0, m_BlockCount);
