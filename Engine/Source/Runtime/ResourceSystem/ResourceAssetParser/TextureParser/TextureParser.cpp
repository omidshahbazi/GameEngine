...
namespace Engine
{
	...
	namespace ResourceAssetParser
	{
		...
		uint64 TextureParser::GetDumpSize(const TextureInfo& TextureInfo)
		{
			...
			return sizeof(int32) + sizeof(int32) + sizeof(int32) + sizeof(int32) + sizeof(int32) + sizeof(int32) + sizeof(int32) + sizeof(int32) + Helper::GetTextureBufferSize(TextureInfo.Format, TextureInfo.Dimension);// GetImageSize(TextureInfo);
		}
		...
		void TextureParser::Dump(ByteBuffer& Buffer, const TextureInfo& TextureInfo)
		{
			...
			Buffer.AppendBuffer(TextureInfo.Data, 0, Helper::GetTextureBufferSize(TextureInfo.Format, TextureInfo.Dimension));// GetImageSize(TextureInfo));
		}
	}
}