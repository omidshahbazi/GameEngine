...
#define CHECK_CALL(PromiseExpr) \
		...
		//	{
		//		CompiledInfo->MetaInfo.Structs.Add({ structType.Name , {} });
		//		StructMetaInfo& structMeta = CompiledInfo->MetaInfo.Structs[CompiledInfo->MetaInfo.Structs.GetSize() - 1];
		...
		//		CompiledInfo->MetaInfo.Variables.Add({ variableType.DataType, variableType.Name });
