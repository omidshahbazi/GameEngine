	...
	namespace ResourceSystem
	{
		namespace Private
		{
			...
			const String BuiltInAssets::SPRITE_RENDERER_SHADER_SOURCE =
				...
				"if (drawMode == 1)"
				"finalUV = float2(SlicedProcessCoord(uv.x, elemBorderUV.x, elemBorderUV.z, texBorderUV.x, texBorderUV.z), SlicedProcessCoord(uv.y, elemBorderUV.y, elemBorderUV.w, texBorderUV.y, texBorderUV.w));"
				"else if (drawMode == 2)"
				"finalUV = float2(TiledProcessCoord(uv.x, elemBorderUV.x, elemBorderUV.z, texBorderUV.x, texBorderUV.z), TiledProcessCoord(uv.y, elemBorderUV.y, elemBorderUV.w, texBorderUV.y, texBorderUV.w));"
				"}"
