	...
	namespace ResourceSystem
	{
		namespace Private
		{
			...
			const String BuiltInAssets::SPRITE_RENDERER_SHADER_SOURCE =
				...
				"if (drawMode == 1)"
				"finalUV = float2(SlicedProcessCoord(uv.x, elemBorderUV.x, elemBorderUV.z, texBordersUV.x, texBordersUV.z), SlicedProcessCoord(uv.y, elemBorderUV.y, elemBorderUV.w, texBordersUV.y, texBordersUV.w));"
				"else if (drawMode == 2)"
				"finalUV = float2(TiledProcessCoord(uv.x, elemBorderUV.x, elemBorderUV.z, texBordersUV.x, texBordersUV.z), TiledProcessCoord(uv.y, elemBorderUV.y, elemBorderUV.w, texBordersUV.y, texBordersUV.w));"
				"}"
