			...
			get
			{
				XmlElement projectElement = CreateProjectElement();
				{
					...
					XmlElement popertyGroup = CreateElement("PropertyGroup", projectElement);
					{
						...
						targetName.InnerText = AssemblyName;
					}
					...
					AddStringListToEllementAsAttribute(includeFiles, "ClInclude", "Include", IncludeFiles);

					XmlElement compileFiles = CreateElement("ItemGroup", projectElement);
					AddStringListToEllementAsAttribute(includeFiles, "ClCompile", "Include", CompileFiles);
